...
\begin{frame}{Pragmatique}
    ...
    \begin{block}{Exemples}
        \begin{itemize}
            ...
            \item Moi, ma mère, c'est de la moquette
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{exoframe}{Exercice SUR PAPIER !}
    \begin{block}{Procédez à un étiquetage morphosyntaxique de la phrase suivante}
        \begin{itemize} \color{white}
            \item Nous portions des portions.
            \item Aujourd'hui, nous mangeons des pommes de terre.
            \item L'histoire, c'est passionant !
            \item Le rapporteur de l'organisation des nations unies a exprimé ses craintes.
        \end{itemize}
    \end{block}
    \pause
    \vfill
    \begin{center}
        \Large
        Échangez votre feuille avec celle d'un voisin. \\ 
        Êtes vous d'accord ? Sinon, pourquoi ? 
    \end{center}
\end{exoframe}
...
%         Maanantaista torstaihin herään viisitoista yli seitsemän. Perjantaisin herään kahdeksalta, koska oppituntini alkavat myöhemmin. Herättyäni syön aamupalaa, puen päälleni ja menen kouluun. Koulupäiväni päättyy kello kolmelta ja iltapäivällä syön kotona. Rakastan ruoanlaittoa, mutta välillä olen väsynyt, enkä jaksa tehdä ruokaa. Silloin menen ulos syömään.
